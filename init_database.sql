...
LOAD DATA LOCAL INFILE 'path/to/.../data/like_bus.csv'
INTO TABLE LIKE_BUS
FIELDS TERMINATED BY ','
ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
...
LOAD DATA LOCAL INFILE 'path/to/.../data/like_train.csv'
INTO TABLE LIKE_TRAIN
FIELDS TERMINATED BY ','
ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
IGNORE 1 ROWS;

LOAD DATA LOCAL INFILE 'path/to/.../data/like_bike.csv'
INTO TABLE LIKE_BIKE
FIELDS TERMINATED BY ','
ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
IGNORE 1 ROWS;